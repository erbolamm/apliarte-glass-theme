...
import 'apli_glas_bar_item.dart';
import 'apli_glas_bar_style.dart';
import 'apli_glas_item_widget.dart';

/// A beautiful liquid glass bottom navigation bar with smooth
...
/// ```
/// {@end-tool}
class ApliGlasBar extends StatefulWidget {
  ...
  @override
  State<ApliGlasBar> createState() => _ApliGlasBarState();
}

class _ApliGlasBarState extends State<ApliGlasBar> {
  double? _dragAlignment;
  bool _isDragging = false;
  int? _highlightedIndex;

  ApliGlasBarStyle get _style =>
      widget.style ?? const ApliGlasBarStyle();
